...
| 2 | Identity + Gateway | Register, log in, refresh rotation, rate limiting, first end-to-end request | Snowflake IDs, JWT vs sessions, token rotation, token-bucket limiting |
