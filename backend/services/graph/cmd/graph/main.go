// Command graph is a placeholder.
//
// It exists so that go.work resolves and CI has something to vet and build.
// It deliberately does not start a server: graph listens on :50051 and serves the follows graph over gRPC,
// and none of that exists until Phase 3. A stub that opened a port and
...
func main() {
	...
	log.Info("started", "state", "placeholder", "implemented_in", "phase 3")
